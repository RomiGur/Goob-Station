...
uplink-energy-pickaxe-desc = Голографический инструмент для добычи полезных ископаемых с лезвиями, состоящими из твердого света, который также служит смертоносным оружием ближнего боя. Рок энд Стоун!
